...
import MediumIcon from 'src/assets/images/medium-icon.svg';
import TelegramIcon from 'src/assets/images/telegram-icon.svg';
import WebIcon from 'src/assets/images/web-icon.svg';
import { categories, ICategoryType } from 'src/components/constants/filters';
                      ...
                      <div className="category-list-tags">
                        <ul>
                          {/* {onTabCategories && (
                            <> */}
                          {categories.map(
                            (category: ICategoryType, index: number) => (
                              <li
