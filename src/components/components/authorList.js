    ...
    <ol className="author_list">
      <li>
        ...
        <div className="author_list_info">
          <span onClick={() => window.open('', '_self')}>Lank</span>
      ...
      <li>
        ...
        <div className="author_list_info">
          <span onClick={() => window.open('', '_self')}>Lukass</span>
      ...
      <li>
        ...
        <div className="author_list_info">
          <span onClick={() => window.open('', '_self')}>Crypto_Knight</span>
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open('', '_self')}>
            <img className="lazy" src="./img/author/author-13.jpg" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
