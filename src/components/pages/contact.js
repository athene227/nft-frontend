        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="padding40 box-rounded mb30">
              ...
              <address className="s1">
                <span>
                  ...
                  <span className="btn">info@nftonpulse.io</span>
                </span>
                <span>
                  <i className="id-color fa fa-file-pdf-o fa-lg"></i>
                  <span className="btn">Download Whitepaper</span>
                </span>
              </address>
            </div>
            ...
            <div className="padding40 box-rounded mb30 text-light">
              ...
              <address className="s1">
                <span>
                  <i className="fa fa-map-marker fa-lg"></i>Worldwide
                </span>
                <span>
                  <i className="fa fa-phone fa-lg"></i>t.me/nftonpulse
                </span>
              </address>
            </div>
          </div>
