...
import collectionbannerbg from 'src/assets/images/icon/banner-img.svg';
import tabImgbg from 'src/assets/images/tab-img-bg.png';
import tabImgbghover from 'src/assets/images/tab-img-bg-hover.png';
...
const CreateSingleWrapper = styled.div`
  ...
  .nft-create-form {
    ...
    .form-ccfield,
    .createNft__form_field_secondary {
      border: 1px solid ${({ theme }) => theme.colors['input-holder-border']};
      backdrop-filter: blur(40px);
    ...
    .category-dropdown {
      ...
      .btn-grad.btn {
        ...
        background-image: linear-gradient(
          270deg,
          ${({ theme }) => theme.colors.color_primary} 0%,
          ${({ theme }) => theme.colors.color_secondary} 100%
        );
    ...
    .rdrCalendarWrapper {
      ...
      .rdrDay {
        ...
        .rdrDayInPreview {
          background: linear-gradient(
            180deg,
            rgba(244, 5, 201, 0.1) -1.88%,
            rgba(57, 147, 255, 0.1) 129.09%
          );
          border: 0px;
          & + .rdrDayNumber {
            color: #ffffff;
