...
function NftsAndCollections(props: IProps) {
  ...
  const renderContent = () => {
    ...
    return (
      <div id="zero1" className="onStep test fadeIn">
        <ColumnNewRedux
          data={userNfts.data}
          ...
          <div className="col-lg-12">
            <div className="items_filter">
              <ul className="de_nav text-left">
                ...
                >
                  <span onClick={() => changeTab(tabType.on_sale)}>
                    On Sale <strong>2.5k</strong>
                  </span>
                </li>
                <li
                  id="Mainbtn1"
                ...
                >
                  <span onClick={() => changeTab(tabType.created)}>
                    Created <strong>2.5k</strong>
                  </span>
                </li>
                <li
                  id="Mainbtn1"
                ...
                >
                  <span onClick={() => changeTab(tabType.owned)}>
                    Owned <strong>2.5k</strong>
                  </span>
                </li>
                <li
                  id="Mainbtn2"
                ...
                >
                  <span onClick={() => changeTab(tabType.my_collections)}>
                    Collections <strong>2.5k</strong>
                  </span>
                </li>
              </ul>
            </div>
